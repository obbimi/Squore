...
* Import/Export/Reset settings
    * Import settings from a backup, from an URL, or reset to default
      * Note: you can use and URL from which to fetch settings. Typically used to more easily have all devices for a certain event or league use the same settings.
