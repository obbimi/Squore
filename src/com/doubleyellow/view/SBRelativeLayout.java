...
public class SBRelativeLayout extends PercentRelativeLayout /* deprecated in 26.1.0, TODO: migrate to SBConstraintLayout */  implements DrawArrows {
    ...
    @Override public void hideArrows() {
    ...
    @Override public void drawArrow(int[] vRelatedGuiElements, int bgColor) {
        drawArrow(vRelatedGuiElements, null, bgColor);
    }
    /** called e.g. by PromoThread */
    @Override public void drawArrow(int[] vRelatedGuiElements, Direction[] arrowDirection, int bgColor)
    {
