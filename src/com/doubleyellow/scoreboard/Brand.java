...
public enum Brand
{
    ...
    //Badminton       (SportType.Badminton  , R.string.app_name_short_brand_Badminton       , 0/*R.drawable.brand_squore*/                     , R.id.sb_branded_logo_ar150, R.color.brand_badminton_bg_color       , R.string.CUSTOM_RECEIVER_APP_ID_brand_badminton       , R.array.colorSchema_Badminton  , 0                                            , 3000, "http://badminton.double-yellow.be", "18be497c-ddfa-4851-9b43-0a5866605252", R.raw.changelog_badminton),
