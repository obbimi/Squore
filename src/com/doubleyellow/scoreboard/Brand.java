...
public enum Brand
{
  ...
  //Padel           (SportType.Padel      , R.string.app_name_short_brand_Padel           , R.drawable.logo_brand_padel               , R.id.sb_branded_logo_ar400, R.color.brand_padel_bg_color           , R.string.CUSTOM_RECEIVER_APP_ID_brand_shared         , R.array.colorSchema_Padel      , 0                              , 4000, "http://padel.double-yellow.be", "239ad8ef-0cdd-490c-8f01-4d50dd4e7c6b", R.raw.changelog),
