...
public enum Brand
{
    Squore          (SportType.Squash     , R.string.app_name_short_brand_Squash          , 0/*R.drawable.brand_squore*/    , R.id.sb_branded_logo_ar150, R.color.brand_squore_bg_color          , R.string.REMOTE_DISPLAY_APP_ID_brand_squore          , R.array.colorSchema            , 0                                            , 3000, "https://squore.double-yellow.be"   , "8da78f9d-f7dd-437c-8b7d-d5bc231f92ec", R.raw.changelog),
    //Tabletennis     (SportType.Tabletennis, R.string.app_name_short_brand_Tabletennis     , 0/*R.drawable.brand_squore*/            , R.id.sb_branded_logo_ar150, R.color.brand_tabletennis_bg_color     , R.string.CUSTOM_RECEIVER_APP_ID_brand_shared         , R.array.colorSchema_Tabletennis, 0                                            , 3000, "https://tabletennis.double-yellow.be", "e35d8fcb-a7c0-4c2a-9c74-cc3f6e1e6a41", R.raw.changelog_tabletennis),
    //Badminton       (SportType.Badminton  , R.string.app_name_short_brand_Badminton       , 0/*R.drawable.brand_squore*/            , R.id.sb_branded_logo_ar150, R.color.brand_badminton_bg_color       , R.string.CUSTOM_RECEIVER_APP_ID_brand_shared         , R.array.colorSchema_Badminton  , 0                                            , 3000, "https://badminton.double-yellow.be", "18be497c-ddfa-4851-9b43-0a5866605252", R.raw.changelog_badminton),
    ...
    //TennisPadel     (SportType.TennisPadel, R.string.app_name_short_brand_TennisPadel     , R.drawable.logo_brand_tennispadel         , R.id.sb_branded_logo_ar400, R.color.brand_padel_bg_color           , R.string.CUSTOM_RECEIVER_APP_ID_brand_shared         , R.array.colorSchema_TennisPadel      , 0                              , 4000, "https://tennispadel.double-yellow.be", "239ad8ef-0cdd-490c-8f01-4d50dd4e7c6b", R.raw.changelog_tennispadel),
    //Padel           (SportType.Padel      , R.string.app_name_short_brand_Padel           , R.drawable.logo_brand_tennispadel         , R.id.sb_branded_logo_ar400, R.color.brand_padel_bg_color           , R.string.CUSTOM_RECEIVER_APP_ID_brand_shared         , R.array.colorSchema_TennisPadel      , 0                              , 4000, "https://tennispadel.double-yellow.be", "0ccc9dea-f8c9-4d69-83b2-8a51508f9ae8", R.raw.changelog_tennispadel),
  //Racquetball     (SportType.Racquetball, R.string.app_name_short_brand_Racquetball     , 0/*R.drawable.brand_squore*/              , R.id.sb_branded_logo_ar150, 0                                      , R.string.REMOTE_DISPLAY_APP_ID_brand_Racquetball     , R.array.colorSchema_Racquetball, 0                                            , 3000, "https://racquetball.double-yellow.be", R.raw.changelog),
  ...
  //XXXOfNotthingham(SportType.Squash     , R.string.app_name_short_brand_uniofnotthingham, R.drawable.brand_uniofnotthingham         , R.id.sb_branded_logo_ar150, R.color.brand_uniofnotthingham_bg_color, R.string.REMOTE_DISPLAY_APP_ID_brand_uniofnotthingham, R.array.colorSchema_UoN        , R.string.brand_uniofnotthingham_color_name_re, 4000, "https://squore.double-yellow.be", R.raw.changelog_courtcare),
  //UniOfNotthingham(SportType.Squash     , R.string.app_name_short_brand_uniofnotthingham, R.drawable.brand_courtcare/*_uoncolors*/  , R.id.sb_branded_logo_ar400, R.color.brand_uniofnotthingham_bg_color, R.string.REMOTE_DISPLAY_APP_ID_brand_uniofnotthingham, R.array.colorSchema_UoN        , R.string.brand_uniofnotthingham_color_name_re, 4000, "https://squore.double-yellow.be", R.raw.changelog_courtcare),
    ;
  ...
  //public int getREColorPalette()          { return iREColorPalette;}
    ...
    public Map.Entry<String, String> getRemoteDisplayAppId2Info(Context ctx) {
        if ( m_mCastConfig != null ) {
            List<String> lDefaults = m_mCastConfig.getOptionalList("Default");
            List<String> lBrand    = m_mCastConfig.getOptionalList(this.toString());
            if (ListUtil.isNotEmpty(lDefaults) && ListUtil.isNotEmpty(lBrand) ) {
                lBrand.addAll(lDefaults);
                ListUtil.removeDuplicates(lBrand);
            }
            if (ListUtil.isNotEmpty(lDefaults) && ListUtil.isEmpty(lBrand) ) {
                lBrand = lDefaults;
            }
            int iIdx = PreferenceValues.useCastScreen(ctx);
            iIdx = iIdx % ListUtil.size(lBrand);
            String sCastId = lBrand.get(iIdx);
            return new AbstractMap.SimpleEntry<String, String>(sCastId, m_mCastConfig.getOptionalString(sCastId, sCastId));
        }
