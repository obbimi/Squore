...
public enum Brand
{
  ...
  //UniOfNotthingham(SportType.Squash     , R.string.app_name_short_brand_uniofnotthingham  , R.drawable.brand_courtcare/*_uoncolors*/  , R.id.sb_branded_logo_ar400, R.color.brand_uniofnotthingham_bg_color, R.string.REMOTE_DISPLAY_APP_ID_brand_courtcare       , R.array.colorSchema_UoN        , R.string.brand_uniofnotthingham_color_name_re, 4000, "https://squore.double-yellow.be", "a83bd93b-bcff-4b33-b26e-24f45d2f0d5f", R.raw.changelog_courtcare),
    ;
