...
public enum Brand
{
  ...
  //DScore          (SportType.TennisPadel, R.string.app_name_short_brand__DScore          , 0, 0/*R.drawable.brand_squore*/            , R.id.sb_branded_logo_ar150     , R.string.CUSTOM_RECEIVER_APP_ID_DScore_fancy      , R.array.colorSchema__DScore , "https://d-score.double-yellow.be", "f538f11b-99cc-4cf0-9ead-241fd0e4c245"                                  , 0),
