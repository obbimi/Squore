        ...
        if ( Intent.ACTION_VIEW.equals( action ) ) {
            ...
            if ( url != null ) {
                ...
                if ( bUploadedZipfileURL ) {
                    ...
                    String sFeedURL = sURL.replaceAll("(?:https?)://(?:www\\.|esf\\.|vsf\\.|fir\\.|rfa\\.|squashcanada\\.|wsf\\.|squashse\\.)?(?:toernooi|tournamentsoftware|europeansquash|squash)(?:\\.\\w{2,3}).*id=([A-Za-z0-9-]+).*?$"
