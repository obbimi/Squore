...
public class Handicap extends BaseAlertDialog {
    ...
    @Override public boolean storeState(Bundle outState) {
        ...
        outState.putInt(JSONKey.nrOfGamesToWinMatch.toString(), iNrOfPointsToWinGame);
        return true;
    }

    @Override public boolean init(Bundle outState) {
        init((HandicapFormat) outState.getSerializable(HandicapFormat.class.getSimpleName()), outState.getInt(JSONKey.nrOfGamesToWinMatch.toString()));
        return true;
    }
